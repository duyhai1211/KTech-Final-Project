...
const RestaurantSignUp = ({ handleChange, handleCheckId, handleShowPassword, handleSignUpSubmit,
    validated, showPw }) => {
    return (
        <>
            <Paper elevation={5}>
                <Form noValidate validated={validated} onSubmit={handleSignUpSubmit} className='p-3'>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="formPlaintextName" hasvalidation="true">
                        ...
                        <Col sm="9">
                            <Form.Control required type="text" name="username" onChange={handleChange} />
                            <Form.Control.Feedback type="invalid">입력해주세요</Form.Control.Feedback>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group as={Row} className="mb-3" controlId="formPlaintextName" hasvalidation="true">
                        ...
                        <Col sm="9">
                            <Form.Control required type="text" name="username" onChange={handleChange} />
                            <Form.Control.Feedback type="invalid">주소을 입력해주세요</Form.Control.Feedback>
                        </Col>
                    </Form.Group>
