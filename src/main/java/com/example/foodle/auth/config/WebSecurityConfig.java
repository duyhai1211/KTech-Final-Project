    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/users/login", "/users/signin", "/users/signup", "/users/signup-owner", "/search","restaurant/{restaurantId}/menu","restaurant/all","restaurant/{restaurantId}")
                            .permitAll();
...
//                    auth.requestMatchers("users/main",
//                                    "/users/login",
//                                    "/users/signin",
//                                    "/users/signup",
//                                    "/users/signup-owner",
